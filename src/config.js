...
(function (global) {
  ...
  const PATTERNS = [
    ...
    // 「加我vx/加我微信/加我qq」口语缩写引流（"加我好友"不匹配，不误杀）
    { id: 'jiawoContact', re: /加我.{0,3}(?:vx|wx|V|v|微信|qq|Q|企鹅|薇|微)/, w: 25, label: '加我联系方式' },
    // 懂的 + 行动词 = 引流
    { id: 'dongdeAct', re: /懂的(?:来|私|加|联系|滴滴)/, w: 25, label: '懂的来引流' },
    // 微信 与「公众号/支付/充值/搜/关注」等连用是正常语境，降权——「微信搜「公众号名」」是内容营销标准句式
    { id: 'wechatLegit', re: /微信.{0,4}(?:公众号|读书|支付|运动|步数|登录|扫码|收款|转账|红包|小程序|支付宝|充值|钱包|零钱|搜|搜索|关注)/, w: -20, label: '微信正常语境' },
    // 价格 + 元（「300/2小时」）
