...
(function (global) {
  ...
  const PATTERNS = [
    ...
    { id: 'price', re: /(嫖|炮|包夜|全套|半套|上门|快餐|出台|服务|小时|一次|一夜|夜|约)\S{0,8}\d{2,4}\s*(元|块|rmb|RMB|k|K)?/, w: 40, label: '价格信息' },
    ...
    // 个人向擦边自夸（代词在 3 字内）：「我太涩了」「她好骚」「比她骚」——
    // 覆盖 我/她/他/它 人称变体（广告账号批量换代词），规避"这波操作太骚了"等游戏用语
    { id: 'personalLewd', re: /(我|人家|俺|本人|自己|人家我|她|他|它|她们|他们).{0,3}(太涩|好涩|涩涩|太骚|好骚|骚不骚|比我骚|比她骚|比他骚|有点涩|有点骚)/, w: 16, label: '个人擦边话术' },
    // 代词 + 零距离騷/涩（"没我骚""比她骚"）；2 字内限制规避"他家猫太骚了"
    { id: 'personalLewdBare', re: /(我|人家|俺|本人|自己|人家我|她|他|它|她们|他们).{0,2}(骚|涩)/, w: 14, label: '自称擦边' },
    // 宠物玩笑负向（"我家猫太骚了"）
    ...
    // 微信 与「公众号/支付/读书」连用是正常语境，降权
    { id: 'wechatLegit', re: /微信(?:公众号|读书|支付|运动|步数|登录|扫码|收款|转账|红包|小程序)/, w: -20, label: '微信正常语境' },
    // 价格 + 元（「300/2小时」）
