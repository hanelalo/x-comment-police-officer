...
(function (global) {
  ...
  const PATTERNS = [
    ...
    // 个人向擦边自夸（需"我"在 3 字内）：「我太涩了」「人家好骚」「比我骚」——规避"这波操作太骚了"等游戏用语
    { id: 'personalLewd', re: /(我|人家|俺|本人|自己|人家我).{0,3}(太涩|好涩|涩涩|太骚|好骚|骚不骚|比我骚|有点涩|有点骚)/, w: 16, label: '个人擦边话术' },
    // 我/人家 + 零距騷/涩（"没我骚""比我骚"）；2 字内限制规避"我家猫太骚了"
    { id: 'personalLewdBare', re: /(我|人家|俺|本人|自己|人家我).{0,2}(骚|涩)/, w: 14, label: '自称擦边' },
    // 宠物玩笑负向（"我家猫太骚了"）
